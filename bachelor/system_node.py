...
class SystemNode(Node):
    ...
    def __init__(self):
        ...
        self.linestruefalse = False

        

    def listener_callback(self, data):
        # Display the message on the console
        self.get_logger().info('Receiving lines data')
        self.linestruefalse = data
